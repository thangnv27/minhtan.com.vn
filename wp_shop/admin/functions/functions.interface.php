...
function optionsframework_add_admin() {
    ...
    $of_page = 
//	add_menu_page( THEMENAME, 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
	add_menu_page( THEMENAME, 'Themes Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page','', 25 );
	
	// add_menu_page( 'Booking', 'Booking tour', 'manage_options', 'vnking_booking', 'booking_tour_admin', plugins_url( 'vnking_booking/images/travel-icon.png' ), 6 ); 
